...
pub mod metadata_service_client {
    ...
    /// MetadataService is the service that provides metadata for contents.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// Materialize materializes the metadata of a content.
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/metadata.MetadataService/Materialize",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("metadata.MetadataService", "Materialize"));
...
pub mod metadata_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/metadata.MetadataService/Materialize" => {
                    ...
                    struct MaterializeSvc<T: MetadataService>(pub Arc<T>);
                    impl<
                        T: MetadataService,
                    ...
                    for MaterializeSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MetadataService>::materialize(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "metadata.MetadataService";
