...
pub mod notification_service_client {
    ...
    /// NotificationService is the service that handles notification requests.
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("notification.NotificationService", "Send"));
...
pub mod notification_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/notification.NotificationService/Send" => {
                    ...
                    struct SendSvc<T: NotificationService>(pub Arc<T>);
                    impl<
                        T: NotificationService,
                    ...
                    for SendSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as NotificationService>::send(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "notification.NotificationService";
